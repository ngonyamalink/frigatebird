...
<footer class="py-4 bg-light mt-auto">
	<div class="container-fluid">
		<div class="d-flex align-items-center justify-content-between small">
			<div class="text-muted">Copyright &copy; Frigate Bird <?php echo date("Y");?> - Powered
				By Ngonyama Link (Pty) Ltd</div>
			<div>
				<a href="<?php echo base_url("welcome/privacypolicy"); ?>">Privacy
					Policy</a> &middot; <a
					href="<?php echo base_url("welcome/termsandconditions"); ?>">Terms
					&amp; Conditions</a>
			</div>
		</div>
	</div>
